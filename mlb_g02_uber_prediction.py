...
We will evaluate multiple machine learning models (Logistic Regression, Random Forest, XGBoost, Hist Gradient Boost) using metrics like ROC-AUC, F1-score, and precision-recall balance. Our goal is to build a model that can achieve strong predictive performance, ideally exceeding 75% accuracy and robust recall for cancellations
